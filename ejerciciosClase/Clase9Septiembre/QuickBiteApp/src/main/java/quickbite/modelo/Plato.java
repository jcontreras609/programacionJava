...
public class Plato {
    ...
    // un unico contructor que recibe los tres valores como parametros
    ...
    public void despachar(int cantidad) {
        ...
        if(hayDisponibilidad == true){
            ...
            System.out.print("Actualizamos las formas disponibles");
        } else { 
        
            System.out.print("¡Advertencia! No hay disponibilidad");
        }
